      ...
      <div className="max-w-6xl mx-auto space-y-8">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <Card className="cyberpunk-card flex-1">
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Badge variant="outline" className="border-green-400 text-green-400 px-3 py-1 font-semibold">
                  ACTIVE
                </Badge>
              </div>
              <CardDescription className="text-foreground/80">Real-time cheat detection system</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-muted/50 p-3 rounded-md">
                  <p className="text-xs text-foreground/70 font-medium">Engine Version</p>
                  <p className="font-semibold text-foreground">GhostGuard v4.2.1</p>
                </div>
                <div className="bg-muted/50 p-3 rounded-md">
                  <p className="text-xs text-foreground/70 font-medium">Definitions</p>
                  <p className="font-semibold text-foreground">Updated 12 minutes ago</p>
                </div>
                <div className="bg-muted/50 p-3 rounded-md">
                  <p className="text-xs text-foreground/70 font-medium">Scan Mode</p>
                  <p className="font-semibold text-foreground">Deep + Heuristic</p>
                </div>
              </div>
          ...
          <Card className="cyberpunk-card w-full md:w-80">
            <CardHeader>
              <CardTitle className="text-xl text-foreground">Detection Summary</CardTitle>
              <CardDescription className="text-foreground/80">Last 24 hours</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-red-950/30 p-3 rounded-md border border-red-500/40">
                  <p className="text-xs text-foreground/70 font-medium">High Severity</p>
                  <p className="text-xl font-bold text-red-400">2</p>
                </div>
                <div className="bg-yellow-950/30 p-3 rounded-md border border-yellow-500/40">
                  <p className="text-xs text-foreground/70 font-medium">Medium Severity</p>
                  <p className="text-xl font-bold text-yellow-400">3</p>
                </div>
                <div className="bg-blue-950/30 p-3 rounded-md border border-blue-500/40">
                  <p className="text-xs text-foreground/70 font-medium">Low Severity</p>
                  <p className="text-xl font-bold text-blue-400">2</p>
                </div>
                <div className="bg-green-950/30 p-3 rounded-md border border-green-500/40">
                  <p className="text-xs text-foreground/70 font-medium">Players Banned</p>
        ...
        <Card className="cyberpunk-card">
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle className="text-xl text-foreground">Anti-Cheat Alerts</CardTitle>
              <Badge variant="outline" className="px-3 py-1 font-semibold text-foreground/80">
                {filteredEvents.length} Events
              </Badge>
            </div>
            <CardDescription className="text-foreground/80">Detected suspicious activities and violations</CardDescription>
          </CardHeader>
          <CardContent>
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
                    ...
                    <table className="w-full caption-bottom text-sm">
                      <thead className="[&_tr]:border-b">
                        <tr className="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                          <th className="h-10 px-4 text-left align-middle font-semibold text-foreground/80">
                            Severity
                          </th>
                          <th className="h-10 px-4 text-left align-middle font-semibold text-foreground/80">Player</th>
                          <th className="h-10 px-4 text-left align-middle font-semibold text-foreground/80">Event</th>
                          <th className="h-10 px-4 text-left align-middle font-semibold text-foreground/80">Time</th>
                          <th className="h-10 px-4 text-left align-middle font-semibold text-foreground/80">
                            Actions
                          </th>
                        </tr>
                      ...
                      <tbody className="[&_tr:last-child]:border-0">
                        {filteredEvents.map((event) => (
                          ...
                          >
                            ...
                            <td className="p-4 align-middle font-semibold text-foreground">{event.player}</td>
                            <td className="p-4 align-middle text-foreground/90">{event.event}</td>
                            <td className="p-4 align-middle text-foreground/70 font-medium">
              ...
              <TabsContent value="players" className="m-0">
                <div className="rounded-md border p-8 text-center">
                  <p className="text-foreground/70 font-medium">Player analysis view coming soon</p>
                </div>
              </TabsContent>

              <TabsContent value="settings" className="m-0">
                <div className="rounded-md border p-8 text-center">
                  <p className="text-foreground/70 font-medium">Anti-cheat settings view coming soon</p>
                </div>
              </TabsContent>
            </Tabs>
          </CardContent>
